...
- (void)startCanvasAnimation {
    ...
    [class performAnimationOnView:self duration:self.duration delay:self.delay distance:self.distance damping:self.damping velocity:self.velocity animator:self.animator];
